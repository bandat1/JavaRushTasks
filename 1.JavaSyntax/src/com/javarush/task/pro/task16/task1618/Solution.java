...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ...
        int differenceHours  = time2.getHour() - time1.getHour();
        int differenceMinutes = time2.getMinute() - time1.getMinute();

        LocalDateTime result = fromDateTime.plusHours(differenceHours).plusMinutes(differenceMinutes);
