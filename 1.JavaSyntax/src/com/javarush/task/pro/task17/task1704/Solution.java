...
public class Solution {
    ...
    public static void runWorkingProcess() {
        ...
        Human astronaut1 = (Human) astronauts.get(0);
        Human astronaut2 = (Human) astronauts.get(1);
        Cat astronautCat = (Cat) astronauts.get(3);
        Dog astronautDog = (Dog) astronauts.get(2);
        pilot(astronaut1);
        pilot(astronaut2);
        research(astronautCat);
        createDirection(astronautDog);
    }
