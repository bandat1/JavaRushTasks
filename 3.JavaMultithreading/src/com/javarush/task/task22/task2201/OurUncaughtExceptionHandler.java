...
public class OurUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     * 3. Реализуй логику трех protected методов в OurUncaughtExceptionHandler используя вызовы соответствующих
     * методов согласно следующим шаблонам:
     * a) 1# : StringForFirstThreadTooShortException : java.lang.StringIndexOutOfBoundsException: String index out of
     * range: -1
